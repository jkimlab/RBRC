...
### PATH  ###
my $lastz = "$Bin/../third_party/lastz-distrib-1.04.00/src/lastz";
my $kent_src = "$Bin/../third_party/kent";
...
`mkdir -p $out_dir`;
### Alignment parameter ###
my $chainPar = "-minScore=5000 -linearGap=$Bin/../sources/lastz_params/near.linearGap";
my $lastzPar = "E=150 H=2000 K=4500 L=2200 M=254 O=600 Q=$Bin/../sources/lastz_params/near.q T=2 Y=15000";
